...
window.ARTS = [
  ...
  },
  {
    ...
    worldview: {
      title: 'All is number',
      sub: 'why the Pythagoreans made counting a doorway to being itself',
      body: [
        'To the classical mind, Arithmetic was never only a means of reckoning. It was the study of the first principle of all things. The Pythagoreans, according to a tradition running back through Aristotle to Pythagoras himself, held that number is the ground of reality — that "all is number," and that whoever understood number understood the frame on which the world is built.',
        'The reason lay in what they had heard and seen. Pluck a string and halve it, and the note leaps an octave: the concord is a ratio, 2 to 1. The perfect fifth is 3 to 2, the fourth 4 to 3. Beauty in sound turned out to be simple whole number made audible. If number governed harmony, they reasoned, why not the heavens, the seasons, the soul? They looked, and found ratio everywhere they looked.',
        'So they gave numbers a character. Some were called perfect, being equal to the sum of their own divisors, as 6 is the sum of 1, 2 and 3. Some were triangular, some square, some friendly to one another. To contemplate these was, for them, to contemplate the shape of being — not to calculate, but to see.',
        'Boethius, carrying this vision into the Latin world, named Arithmetic the first of the four mathematical arts and the ground beneath the other three: Geometry is number given magnitude, Music is number heard in time, Astronomy is number set in motion through the heavens. Take number away and none of them stands. In this ordering, to learn arithmetic first was to lay the foundation of every science that followed.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength: that the mind, in counting, is not inventing a convenience but touching the very structure of what is — and that the child\'s first "one, two, three" is already a step onto holy ground.'
      ]
    },
    faq: [
  ...
  },
  {
    ...
    worldview: {
      title: 'God geometrizes',
      sub: 'the figure of certain, changeless, eternal truth',
      body: [
        'Over the door of Plato\'s Academy, tradition says, were the words: "Let none ignorant of geometry enter here." For the classical mind this was no mere entrance requirement. Geometry was held to be the training by which the soul is turned away from what shifts and decays and toward what is fixed, necessary, and eternal — a first step, Plato taught, from the visible world to the intelligible.',
        'What made geometry so is the peculiar force of its truths. The angles of a triangle summed to two right angles before there were any triangles drawn in sand, and will still sum to two right angles when the last drawing has crumbled. A proof, once seen, could not be otherwise. Here, the ancients held, was a knowledge that owed nothing to opinion or the senses — a glimpse of being that simply is, apart from time.',
        'From this came the saying attributed to Plato: that God geometrizes — that the maker of the cosmos works by measure, figure and proportion. His Timaeus builds the very elements out of geometric solids: earth from the cube, fire from the tetrahedron, and the whole ordered by the five perfect bodies we still call the Platonic solids. The world, on this view, is not a heap of stuff but a made thing, and the pattern of its making is geometric.',
        'This is why Euclid ordered the Elements as he did — 465 propositions raised from a handful of definitions, postulates, and common notions. It was meant to be more than a manual of shapes. It was a demonstration of how certain knowledge is built: everything shown from almost nothing, each step compelled by what went before. Every later science that reached for rigour — Newton, Spinoza in his ethics, the medieval theologians — took this form as its model.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength: that in the proof of a theorem the mind is not making truth but finding it — touching something the ancients believed was there before us, will outlast us, and shows, in its very changelessness, the mark of the eternal.'
      ]
    },
    faq: [
  ...
  },
  {
    ...
    worldview: {
      ...
      sub: 'when the classical mind found the same concord in the string, the soul, and the sky',
      body: [
        'The classical mind began from a fact anyone can hear: pluck a string, halve it, and the note rises a clear octave — a concord that is nothing but a simple ratio, 2 to 1. The fifth is 3 to 2, the fourth 4 to 3. Pythagoras is said to have grasped, in that moment, something vast: that the sweetness the ear loves is whole number made audible. Beauty in sound is mathematics heard.',
        'If number ruled the string, the ancients reasoned, why should it not rule all that is well-ordered? They came to believe that the same proportions run through everything — and so the study of music was the study of proportion itself, wherever it is found.',
        'Boethius, gathering this tradition for the Latin West, set out three musics, of which the sounding kind is only the last. First is musica mundana, the music of the world: the ordered motions of the heavens, the turning spheres and seasons, held in their courses by ratio. The Pythagoreans held that the planets, wheeling through the vast, sound a harmony too constant and too great for mortal ears to catch — the music of the spheres. Kepler, two thousand years later, still searched for those harmonies and titled his book Harmonices Mundi in earnest.',
        'Second is musica humana, the music of the human being: the tuning of soul to body, and of the soul\'s own parts to one another, in a person rightly ordered. On this view the good soul is a well-tuned instrument, and virtue is a kind of harmony. Plato and Aristotle both taught that the music a person hears shapes the soul toward concord or discord — and so the choosing of music was a grave matter, not a diversion.',
        'Only third comes musica instrumentalis — the singing and playing we now simply call music. In the classical ordering it is the lowest of the three not because it matters least, but because it is the audible echo of the two higher harmonies: in a true melody the ear catches, for a moment, the same order that holds the stars in their courses and the soul in its peace.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength: that a struck chord, a tuned soul, and a turning heaven are three voices of one proportion — and that to love music rightly is to be drawn, through the ear, toward the order of the whole.'
      ]
    },
    faq: [
  ...
  },
  {
    ...
    worldview: {
      title: 'The heavens as the ancients read them',
      sub: 'an ordered, changeless, divine cosmos — and why it lifted the mind',
      body: [
        'To the classical mind the night sky was the most orderly and beautiful thing the eye could reach, and Astronomy was the art that turned the mind from the shifting things of earth toward the eternal. Plato, in the Timaeus, taught that sight was given us above all so that, watching the ordered wheeling of the heavens, we might bring the troubled circuits of our own thought into the same order. To study the sky was to be schooled by it.',
        'The cosmos they read there was one thing entire: the Earth at rest in the middle, wrapped in nested crystalline spheres that carried the Moon, the Sun, the five wandering planets, and, outermost, the fixed stars. Ptolemy, in the work the Arabs would call the Almagest, described these motions with such patience that his geometry predicted the heavens for fourteen centuries. It was a cosmos finite, ordered, and knowable to the end.',
        'And it was divided in kind. Below the Moon lay the realm of change — birth, decay, the four elements rising and falling. Above it lay the heavens: changeless, ungenerated, moving in the one perfect figure, the circle, without beginning or end. Aristotle held the stars to be made of a fifth element, the aether, which knows no corruption. The ancients looked up and saw not empty space but a higher, incorruptible order — many called it divine — turning in perfect time above a restless earth.',
        'This is why they counted Astronomy among the arts of a free person, the crown of the Quadrivium — number set moving through the heavens. It humbled the mind with the scale of the whole and elevated it with the order of the whole, both at once. Ptolemy himself wrote that when he traced the wheeling of the stars, his feet no longer touched the earth, but he stood beside Zeus and took his fill of ambrosia.',
        'When Copernicus set the Sun in the middle and Kepler drew the orbits as ellipses, the Earth lost its central seat — but the deeper conviction did not fall. The heavens were still held to be ordered, and the order still held to be knowable; Kepler read his ellipses as the very harmony of the spheres made calculable, and believed to his last day that he was reading the mind of the Maker in the sky.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength: that the ancients gazed upward and found not a void but a cosmos — measured, beautiful, and above all ordered — and that to learn its motions was, for them, to be lifted out of the small and the passing and set, for an evening, among things that do not change.'
      ]
    },
    faq: [
      ...
      { q: 'The classical model put the Earth at the centre — why study it now?', a: 'Because it is one of the great achievements of the human mind and it carries a conviction the later astronomy inherited whole: that the heavens are ordered and the order can be known. Ptolemy\'s geometry predicted the sky for fourteen centuries. When Copernicus moved the Earth and Kepler drew the orbits as ellipses, the centre shifted but the deeper faith in an ordered, knowable cosmos did not. To follow how that picture was built and reshaped is one of the great lessons in what knowledge is.' },
    ...
    sections: {
      'what-it-is': {
        ...
        principles: [
          ...
          { name: 'The classical cosmos: ordered, hierarchical, knowable', body: 'The Ptolemaic universe placed the Earth at the centre, wrapped in concentric crystalline spheres carrying the Moon, Sun, planets, and fixed stars — the realm of change below the Moon, the changeless heavens above. Its governing conviction was that the heavens are ordered and the order can be known, and Ptolemy\'s geometry made good on it, predicting the sky for fourteen centuries.', why: 'When Copernicus set the Sun in the middle, the centre shifted but the conviction held: the cosmos was still read as ordered and knowable. That continuity — from Ptolemy through Kepler to Newton, each finding a deeper order than the last — is the through-line of the whole science.' },
...

  {
    ...
    worldview: {
      title: 'How the Stoics saw the cosmos',
      sub: 'The order that gives the whole philosophy its backbone',
      body: [
        'To the Stoic, the practice and the cosmos are one thing, and the calm they teach rests on what they held the universe to be. Take away their physics and you have technique without its root; hold the two together and the philosophy stands at its full height.',
        'They held the whole of nature to be a single living being, rational through and through, ordered by an intelligent principle they called the logos — reason, or God, not seated somewhere above the world but running through it as fire and breath (pneuma) run through a living body and hold it together. The cosmos, for them, is not dead matter pushed about by chance; it is as much a mind as a thing.',
        'Because that reason governs everything, nothing falls out by accident. Every event follows from the whole in one unbroken chain of cause, which the Stoics called fate (heimarmenē) — and, in the same breath, providence (pronoia), for the order is not blind but good. To grasp this, they taught, is to see why one could welcome whatever came: not resignation, but trust that the same reason which made you is at work in each moment.',
        'Each human mind, they held, is a fragment of that cosmic reason — a spark of the divine fire. This is why we can understand the world at all, and why every person, of any nation or station, is kin: we are fellow citizens of a single cosmic city (cosmopolis). Justice, then, is not a rule pressed on us from outside but our own rational nature carried through to others.',
        '"Live according to nature" means exactly this: bring your own reason into agreement with the reason of the whole — will what the cosmos wills, and do the work of a rational, social creature within it. And when the great cycle closes and the ordering fire gathers all things back into itself to begin the world afresh (the ekpyrōsis, the eternal recurrence), the wise accept even their own ending as one note resolving into a larger, rational music.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength, for it is the ground the Stoic stands on: he faces loss, pain and death unshaken because he trusts that the order which produced him is entire, intelligent, and on the whole good — and that his part is simply to play his role well and hand it back without complaint.'
      ]
    },
    faq: [
      ...
      { q: 'Do the daily practices depend on the Stoic view of the cosmos?', a: 'For the Stoics themselves the two were inseparable: the calm of "accept what comes" rests on their trust that what comes belongs to a rational, providential order. A newcomer can begin with the exercises and meet the physics afterwards — but it is worth meeting rather than setting aside, because that worldview is what gives the practice its backbone. Read it on its own terms (see "How the Stoics saw the cosmos" above) and judge for yourself.' },
