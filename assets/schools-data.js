...
window.ARTS.push(
  {
    ...
    worldview: {
      title: 'How the Platonists saw reality',
      sub: 'The two worlds, and the ascent from shadow to light',
      body: [
        'For the Platonist the practice and the vision of reality are one thing: to hunt definitions, to turn from the senses, to follow the ascent of love, only make sense because the world is built in two storeys — and the higher one is the true home of the soul.',
        'Plato taught that there are two orders of being. There is the world our eyes report — the shifting, dying stream of things that come to be and pass away, forever becoming and never simply being. And beyond it there is the realm of the Forms: Justice itself, Beauty itself, the Circle itself, single and changeless and perfect, of which every fine or fair or round thing here is a faint and passing copy. The Forms are not thoughts in anyone\'s mind but realities more solid than stone; the visible world is their shadow.',
        'Over all the Forms, the school held, stands the Form of the Good, which Plato likened to the sun. As the sun both lets the eye see and makes things grow, so the Good gives the other Forms both their intelligibility and their very being. It is the single source from which everything real and everything worth loving descends, and the summit toward which every ascent is climbing.',
        'The cosmos itself, Plato tells in the Timaeus, was shaped by a divine Craftsman — the Demiurge — who, being good and free of envy, looked to the eternal patterns and fashioned the visible world as their moving image, as near to the perfect as changing matter would allow. The order and beauty we meet in the heavens are the Forms reflected in time.',
        'And the soul, they held, is kin to that higher realm — akin to the Forms, and like them deathless. Having beheld the eternal patterns before its birth, it can turn from the copy to the original and climb back home: from shadow, to the things that cast them, to the Forms grasped by pure intellect, and at last to the Good. This ascent, from becoming to being, is the whole of the philosophic life.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength, for it is the ground the Platonist stands on: he turns from the world of sense not out of contempt for it but because he trusts that it points beyond itself to something changeless and good — and that the soul, if it will only remember, can rise to meet it.'
      ]
    },
    faq: [
      { q: 'Are the Forms just ideas in our heads?', a: 'No — that is the modern sense of the word "idea," but Plato held the Forms to be realities more solid than stone, existing whether or not anyone thinks of them. Our ideas are at best faint images of them. This is a claim the school makes in full earnest; meet it on its own terms (see "How the Platonists saw reality" above) and weigh it, for the whole discipline of asking "what is the thing itself?" grows from it.' },
      { q: 'What did Plato mean by saying the soul lived before birth?', a: 'Plato taught that the soul, being kin to the eternal Forms and itself deathless, beheld those Forms before it entered a body — which is why he could argue that all learning is really recollection, the soul remembering what it once saw. It is a genuine claim of the school, bound up with its vision of an immortal soul at home in a higher world; read it in that light and decide for yourself where it leads.' },
...

  {
    ...
    worldview: {
      title: 'How Aristotle saw the cosmos',
      sub: 'A world of natures and ends, drawn upward by the divine',
      body: [
        'For Aristotle the ethics grows straight out of a vision of the whole: everything that exists has a nature and an end, and the good of anything — a seed, a city, a soul — is the full flowering of what it is. Grasp how he saw the world, and the doctrine of virtue stops being a set of rules and becomes the working-out of a human being\'s own nature.',
        'Nature, he held, does nothing in vain. Everything that is has a telos, a purpose it is for: the acorn is for the oak, the eye for seeing, the human being for the activity of reason. This is his fourth and highest cause — the final cause, that for the sake of which a thing exists — and without it, he taught, you have not truly explained anything, only listed its matter and its motions.',
        'Each thing, on his account, is a union of form and matter (hylomorphism): the matter is what it is made of, the form is what it is — the shape and structure and characteristic activity that makes this bronze a statue, this flesh a living animal. The form is no separate Form in a heaven beyond, as his teacher Plato held, but is present in the thing itself, drawing its matter toward completion as potentiality passes into full actuality.',
        'From this the whole of living nature falls into an ordered hierarchy: plants that only feed and grow, animals that also sense and move, and the human being who adds reason to both — the rational and political animal, in whom nature reaches its highest earthly form. To know any of them is to grasp its nature; knowledge, for Aristotle, is exactly this, the mind taking in the natures of things.',
        'And the whole moving order hangs, at its summit, on the Unmoved Mover — pure actuality, thought thinking itself, wholly complete and without change. It moves all things not by pushing but as the beloved moves the lover: every nature strives toward its perfection, and so the entire cosmos is drawn upward, as by love, toward that first and divine reality on which the heavens and all of nature depend.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength, for it is the ground Aristotle stands on: he can say what a good human life is because he holds that a human being, like everything else, has a real nature and a real end — and that to flourish is simply to become, fully and excellently, the rational creature one already is.'
      ]
    },
    faq: [
      ...
      { q: 'How does his view of nature connect to his ethics?', a: 'They are one vision, and the ethics is stronger for the metaphysics beneath it. Because every nature has an end (telos), the human good is fixed by what a human being is — the rational animal whose flourishing is reason lived out in virtue. Aristotle puts the Ethics first for the reader\'s formation, but the account of nature, purpose, and the four causes (see "How Aristotle saw the cosmos" above) is what gives the good life its ground, not a separate technicality to be skipped.' },
...

  {
    ...
    worldview: {
      title: 'How the Epicureans saw the universe',
      sub: 'A world of atoms and void — and the liberation it brings',
      body: [
        'For the Epicurean the calm they teach and the picture of nature they hold are one thing. The freedom from fear is not a mood willed into being; it is what follows, of itself, once you truly understand what the universe is made of. Take away the physics and the peace loses its root; hold the two together and the fear of the gods and of death simply falls away.',
        'They taught that everything that exists is atoms and void — indivisible bodies moving through empty space — and nothing besides. The universe is infinite in extent and eternal, uncreated and undying, holding countless worlds like our own scattered through the boundless deep. Nothing comes from nothing and nothing is destroyed into nothing; all that happens is atoms meeting, joining, and parting, by their own nature, needing no hand to guide them.',
        'Yet the atoms are not locked in an iron chain of fate. As they fall through the void they now and then swerve, ever so slightly, from their course — the clinamen — and from that swerve arise the meetings that make worlds, and the room in which a free will can move. The Epicurean is no fatalist: the future is genuinely open, and our choices are genuinely our own.',
        'The soul itself, they held, is bodily — a fabric of especially fine and swift atoms, woven through the flesh and alive only while the two are joined. At death the body\'s vessel breaks and those soul-atoms scatter and disperse; there is no one left to be harmed, no shade to be punished, no eternity of dread. This is why "death is nothing to us": where we are, death is not, and where death is, we are not.',
        'The gods, the Epicureans insisted, are real — but they are perfectly blessed and perfectly untroubled, living in the calm between the worlds, and precisely because they are blessed they neither made this world nor meddle in it, nor lie awake over human affairs. To fear their anger, or to buy their favour, is to slander their happiness. The truly pious person is not the frightened one but the one who sees the gods as they are, serene, and takes them as the pattern of the tranquil life.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength, and meeting it as the Epicureans meant it — not as a bleak denial but as a great deliverance. To grasp that the world runs by natural causes, that the gods will not harm you, and that death is simply the end of sensation, is to have the two heaviest terrors lifted from the mind at a stroke, and to be handed back the one life you have, clear and whole, to be lived with gratitude now.'
      ]
    },
    faq: [
      ...
      { q: 'What did the Epicureans hold about the gods and the soul?', a: 'They taught that all things, the soul included, are made of atoms in an infinite universe, that the soul disperses at death, and that the gods are real but blessed and untroubled, taking no part in the world. They offered this not as bleak denial but as liberation — the lifting of the fear of divine anger and of death. Read it as they meant it (see "How the Epicureans saw the universe" above), for that serene naturalism is exactly what gives their calm its ground.' },
...

  {
    ...
    worldview: {
      title: 'How the Cynics saw the world',
      sub: 'Nature as the one true standard, and the whole world as home',
      body: [
        'The Cynics built no great system of the cosmos as the other schools did — and that plainness was itself the point. They held that the truth needed for a good life is not hidden in the heavens or in subtle argument but lies open in nature, in plain sight, for anyone who will stop obeying custom long enough to look.',
        'Their one measure of reality was nature (physis) set against convention (nomos). Hunger, cold, weariness, and death are what nature actually lays on us — real, few, and bearable. Everything else that torments the human race — the craving for gold, the shame of low birth, the hunger for office and applause — is not nature at all but nomos, inherited opinion we mistook for fact. To live according to nature is to throw out whatever fails that test, and to keep only what a human being truly, bodily needs.',
        'From this came their strange and unshakeable freedom. Virtue, they held, is the only good, and it consists in self-sufficiency (autarkeia): owing your contentment to nothing outside your own character. The fewer the props, the fewer the handles by which fortune can seize you — so the beggar who needs nothing is freer than the king who needs everything, and Diogenes in his jar could tell Alexander the Great to step out of his light.',
        'And they refused every smaller citizenship. Asked where he was from, Diogenes is said to have answered that he was a citizen of the world — a kosmopolitēs — belonging to no single city, tribe, or law, but to the whole human race under nature alone. Where nature is the only true country, all merely local walls, ranks, and borders lose their claim, and the wise person is at home anywhere and beholden to no convention.',
        'Whether a reader shares this bare and bracing vision or not, it is worth meeting in its full strength, for it is the ground the Cynic stands on: he can go without, speak the plain truth to anyone, and fear almost nothing, because he trusts that nature has already given, freely and to all, everything a human being needs to live well — and that the rest is a weight we were never meant to carry.'
      ]
    },
    faq: [
...

  {
    ...
    worldview: {
      title: 'How the Confucians saw the order of things',
      sub: 'Heaven, the Way, and a human world woven into the cosmos',
      body: [
        'For the Confucian the daily work of self-cultivation is not a bare human project set against an empty sky. It rests on a conviction that the moral order and the order of the cosmos are one — that when a person becomes humane and a society becomes rightly ordered, they are not inventing goodness but coming into tune with a pattern already woven into the nature of things.',
        'At the source stands Heaven (Tian) — not merely the physical sky but the highest reality, from which the moral order flows. Heaven, the tradition held, is the ground of our very nature: what Heaven confers is called our nature, and to follow that nature is the Way. Confucius spoke of Heaven with reverence and restraint, holding that it does not command in words but reveals itself through the seasons that turn and the world that goes on its course — a silent, unfailing order that the wise learn to read and to trust.',
        'That order is the Way, the Dao — the right pattern that runs through Heaven, earth, and the human world alike, binding them into a single whole. The human realm is not sealed off from the cosmic one; a family well ordered, a state rightly governed, a self made sincere, are each a small answering of the great harmony. To walk the Way is to bring one\'s own conduct into accord with a rightness that is more than merely human.',
        'This is why ritual (li) matters so much and reaches so deep. The forms of courtesy, reverence, and ceremony are not empty etiquette but the means by which a person attunes to that larger order — how one greets, mourns, serves, and honours the dead placing the human being in right relation to family, to society, and beyond them to Heaven and the ancestors. Practised with sincerity, li tunes the self as one tunes an instrument to a note already sounding.',
        'From this comes the Mandate of Heaven: authority is held in trust from Tian, and it holds only so long as it is exercised with virtue and for the people\'s good. The family rightly loving, the ruler rightly just, the self rightly cultivated — each is a reflection, at its own scale, of a greater harmony. Mend the self, and the ordering radiates outward, because self, family, state, and cosmos are continuous, one pattern repeating from the smallest bond to the whole.',
        'Whether a reader shares this vision or not, it is worth meeting in its full strength, for it is the ground the Confucian stands on: he labours to become humane and to keep the rites not as arbitrary custom but because he trusts that human goodness answers to the very order of Heaven and earth — and that a single cultivated person, rightly tuned, helps bring the whole world into harmony.'
      ]
    },
    faq: [
      ...
      { q: 'What did Confucius hold about Heaven and the divine?', a: 'Confucius spoke of Heaven (Tian) with deep reverence, as the source of the moral order and of our very nature, and he honoured the ancestral rites — but he kept his teaching fixed on how to become fully human within the family and community. The tradition sets self-cultivation inside a larger cosmic order (see "How the Confucians saw the order of things" above); its daily practices are lived in the human world, and that continuity between the human and the cosmic is part of their strength.' },
